...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    # Opportunistic maintenance: archive old recordings once/day when enabled.
    try:
        from nssh.core.recording.archive import maybe_run_archive

        maybe_run_archive()
    except Exception:
        # Maintenance failures must not impact primary CLI behavior.
        pass
